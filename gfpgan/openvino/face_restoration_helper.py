...
from .detection_model import init_detection_model
from .parsing_model import init_parsing_model
from .retina_face_openvino import RetinaFaceOpenVINO
...
class FaceRestoreHelper(object):
    ...
    def __init__(self,
        ...
        ov_model = init_detection_model(det_model, half=False, model_rootpath=model_rootpath)
        self.face_det = RetinaFaceOpenVINO(ov_model = ov_model)

        # init face parsing model
        self.use_parse = use_parse
        self.face_parse = init_parsing_model(model_name='parsenet', model_rootpath=model_rootpath)
    ...
    def get_face_landmarks_5(self,
        ...
        if resize is None:
            ...
            print(f"detect input size {input_img.shape}")
